...
from .C_relora import ReLoRaModel
...
def _extract_relora_params(params: Dict[str, Any]) -> tuple[bool, Dict[str, Any]]:
    ...
    config = {
        ...
        "use_c_relora": bool(relora_cfg.get("use_c_relora", False)),
        "c_relora_seed": int(relora_cfg.get("c_relora_seed", relora_cfg.get("seed", 1234567))),
        "c_relora_share_per_width": bool(relora_cfg.get("c_relora_share_per_width", True)),
    }
    return True, config
