"""DinoV2 with Commutator-LoRA adapter."""
...
def build_model(model_name: str, num_classes: int, params: Dict[str, Any]) -> Tuple[nn.Module, Dict[str, Any]]:
    ...
    target_modules = comm_params.get("target_modules", ["query", "key", "value", "dense", "fc1", "fc2"])
    ...
    adapter_dropout = float(comm_params.get("dropout", 0.1))
